...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The sollida Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "sollida Core"
...
#define PACKAGE_BUGREPORT "https://github.com/sollida-project/sollida/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "sollida Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "sollida Core 0.14.2"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "sollida"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://sollida.org/"
