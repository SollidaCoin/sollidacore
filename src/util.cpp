...
const char * const BITCOIN_CONF_FILENAME = "sollida.conf";
const char * const BITCOIN_PID_FILENAME = "sollida.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/sollida";
#else
    // Unix
