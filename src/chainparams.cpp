...
{
    const char* pszTimestamp = "New York Times July 30, 2018 - Trump Administration Mulls a Unilateral Tax Cut for the Rich";
    const CScript genesisOutputScript = CScript() << ParseHex("040B8E1F9AD017BC884367B452CC65A82ACFAB77DBA0B07F3EEE431E6B5A0C8B79266A8A7C02ACD8DB8485800B4761B9FA1FD5568254FCC0D963CD70DCF1F6AA3B") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1535408459, 358220, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xe2695fefac0c7cd9e0704414fc6cf35afa449ea952e512cb2f012dda26c1ad36"));
        assert(genesis.hashMerkleRoot == uint256S("0xe81c9c2d0bc7655c3b8d55c529258723b3a011f18a9f2bcd6e0b7ce6110a15fd"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        //vSeeds.pu131797266513179726651317972665sh_back(CDNSSeedData("loshan.co.uk", "seed-a.sollida.loshan.co.uk", true));
        //vSeeds.pu131797266513179726651317972665sh_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        //vSeeds.pu131797266513179726651317972665sh_back(CDNSSeedData("sollidatools.com", "dnsseed.sollidatools.com"));
        //vSeeds.pu131797266513179726651317972665sh_back(CDNSSeedData("sollidapool.org", "dnsseed.sollidapool.org"));
        //vSeeds.pu131797266513179726651317972665sh_back(CDNSSeedData("koin-project.com", "dnsseed.koin-project.com"));
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1486949366, 1336471, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x8d6d3e196560d6c460970bb3d3d43beec2afda918d77b376836e62c71a4ee455"));
        assert(genesis.hashMerkleRoot == uint256S("0xe81c9c2d0bc7655c3b8d55c529258723b3a011f18a9f2bcd6e0b7ce6110a15fd"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        //vSeeds.pu131797266513179726651317972665sh_back(CDNSSeedData("sollidatools.com", "testnet-seed.sollidatools.com"));
        //vSeeds.pu131797266513179726651317972665sh_back(CDNSSeedData("loshan.co.uk", "seed-b.sollida.loshan.co.uk", true));
        //vSeeds.pu131797266513179726651317972665sh_back(CDNSSeedData("thrasher.io", "dnsseed-testnet.thrasher.io", true));
...
public:
    CRegTestParams() {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xa3dfb12dd7c497ae6b1dc88e49b08917a40edf1cdc87da96fca3b91067c58032"));
        assert(genesis.hashMerkleRoot == uint256S("0xe81c9c2d0bc7655c3b8d55c529258723b3a011f18a9f2bcd6e0b7ce6110a15fd"));
