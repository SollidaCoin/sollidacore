...
pkgdatadir = $(datadir)/sollida
pkgincludedir = $(includedir)/sollida
pkglibdir = $(libdir)/sollida
pkglibexecdir = $(libexecdir)/sollida
...
ACLOCAL = ${SHELL} /sollida/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /sollida/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /sollida/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /sollida/build-aux/missing automake-1.15
AWK = mawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = sollida-cli
BITCOIN_DAEMON_NAME = sollidad
BITCOIN_GUI_NAME = sollida-qt
BITCOIN_TX_NAME = sollida-tx
...
COPYRIGHT_HOLDERS_FINAL = The sollida Core developers
COPYRIGHT_HOLDERS_SUBSTITUTION = sollida Core
COPYRIGHT_YEAR = 2017
CPP = gcc -E
...
MAINT = 
MAKEINFO = ${SHELL} /sollida/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = sollida
PACKAGE_BUGREPORT = https://github.com/sollida-project/sollida/issues
PACKAGE_NAME = sollida Core
PACKAGE_STRING = sollida Core 0.14.2
PACKAGE_TARNAME = sollida
PACKAGE_URL = https://sollida.org/
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /sollida
abs_srcdir = /sollida
abs_top_builddir = /sollida
abs_top_srcdir = /sollida
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /sollida/build-aux/install-sh
...
OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  ...
  $(OSX_APP)/Contents/MacOS/sollida-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
$(OSX_APP)/Contents/MacOS/sollida-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/sollida-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/sollida-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
